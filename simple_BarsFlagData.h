#ifndef simple_BarsFlagData_h
#define simple_BarsFlagData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   simple_BarsFlagData(TString, TTree *tree=0);
   virtual ~simple_BarsFlagData();
...
#ifdef simple_BarsFlagData_cxx
simple_BarsFlagData::simple_BarsFlagData(TString filename, TTree *tree) : fChain(0) 
{
...
simple_BarsFlagData::~simple_BarsFlagData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t simple_BarsFlagData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t simple_BarsFlagData::LoadTree(Long64_t entry)
{
...
void simple_BarsFlagData::Init(TTree *tree)
{
...
Bool_t simple_BarsFlagData::Notify()
{
...
void simple_BarsFlagData::Show(Long64_t entry)
{
...
Int_t simple_BarsFlagData::Cut(Long64_t entry)
{
...
#endif // #ifdef simple_BarsFlagData_cxx
